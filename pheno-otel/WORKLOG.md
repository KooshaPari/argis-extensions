...
| 2026-06-22 | L25-T1 | L25 | add | pheno-otel/src/metrics.rs:1-701 | V22-T1 metrics facade: Metrics struct (Arc-shared facade over OTLP meter provider), Counter/Histogram/Gauge handle types backed by AtomicU64, LabelSet + labels() helper (BTreeMap-backed), 5 example factory methods (http_requests_total, http_request_duration_seconds, active_connections, errors_total, queue_depth), 11-bucket histogram boundary array, MetricsSnapshot serializable export shape, 2 inline tests covering internal invariants. | macbook | forge | sha256:tbd | feat/v22-l25-metrics-2026-06-22 | https://github.com/KooshaPari/phenotype-apps/pull/TBD |
| 2026-06-22 | L25-T1 | L25 | add | pheno-otel/tests/metrics_test.rs:1-80 | V22-T1 metrics facade integration tests (public API only, 2 tests): counter_increment (monotonic add() into Arc<AtomicU64>, label-set isolation), histogram_observation (bucket-indexing against HISTOGRAM_BUCKETS_SECONDS, sum_seconds arithmetic). | macbook | forge | sha256:tbd | feat/v22-l25-metrics-2026-06-22 | https://github.com/KooshaPari/phenotype-apps/pull/TBD |
| 2026-06-22 | L25-T1 | L25 | docs | pheno-otel/docs/metrics/dashboards/api-overview.json:1-1 | V22-T1 Grafana dashboard: L25 API Overview (RPS timeseries, status-code breakdown, top-10 endpoints by traffic; 3 panels; uid pheno-otel-l25-api-overview). | macbook | forge | sha256:tbd | feat/v22-l25-metrics-2026-06-22 | https://github.com/KooshaPari/phenotype-apps/pull/TBD |
| 2026-06-22 | L25-T1 | L25 | docs | pheno-otel/docs/metrics/dashboards/error-budget.json:1-1 | V22-T1 Grafana dashboard: L25 Error Budget (99.9% SLO burn-rate alerts 1h/6h, error-rate by status, error-type breakdown; 3 panels; uid pheno-otel-l25-error-budget). | macbook | forge | sha256:tbd | feat/v22-l25-metrics-2026-06-22 | https://github.com/KooshaPari/phenotype-apps/pull/TBD |
| 2026-06-22 | L25-T1 | L25 | docs | pheno-otel/docs/metrics/dashboards/latency-slo.json:1-1 | V22-T1 Grafana dashboard: L25 Latency SLO (p50/p95/p99 timeseries with 99th < 100ms SLO line, per-endpoint p95 heatmap, latency-vs-throughput correlation; 3 panels; uid pheno-otel-l25-latency-slo). | macbook | forge | sha256:tbd | feat/v22-l25-metrics-2026-06-22 | https://github.com/KooshaPari/phenotype-apps/pull/TBD |
| 2026-06-22 | L25-T1 | L25 | docs | pheno-otel/docs/metrics/dashboards/throughput.json:1-1 | V22-T1 Grafana dashboard: L25 Throughput (RPS by endpoint, request-size distribution, throughput-by-hour-of-day heatmap; 3 panels; uid pheno-otel-l25-throughput). | macbook | forge | sha256:tbd | feat/v22-l25-metrics-2026-06-22 | https://github.com/KooshaPari/phenotype-apps/pull/TBD |
| 2026-06-22 | L25-T1 | L25 | docs | pheno-otel/docs/metrics/dashboards/saturation.json:1-1 | V22-T1 Grafana dashboard: L25 Saturation (active_connections gauge timeseries, queue_depth gauge vs alert thresholds, error-vs-saturation correlation; 3 panels; uid pheno-otel-l25-saturation). | macbook | forge | sha256:tbd | feat/v22-l25-metrics-2026-06-22 | https://github.com/KooshaPari/phenotype-apps/pull/TBD |
